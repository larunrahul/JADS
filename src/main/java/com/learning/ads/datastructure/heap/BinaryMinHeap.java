...
public class BinaryMinHeap<T extends Comparable<T>> {
	...
	/*
	 * Bottom up construction of binaryHeapNode. Elements from half to end are all leaves
	 * of binaryHeapNode tree. Hence we need to start from the parent of last leaf(which
	...
	/*
	 * This runs so long as the height of the binaryHeapNode tree. As height is O(lg n) it
	 * is O(h) where n is number of elements and h is height of binaryHeapNode tree The
